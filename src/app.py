...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, stroke development, and water fitness",
    ...
    "Mathletes": {
        "description": "Competitive math training and problem solving sessions",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["oliver@mergington.edu", "emma@mergington.edu"]
    },
    "Science Bowl": {
        "description": "Team preparation for science trivia and academic competitions",
